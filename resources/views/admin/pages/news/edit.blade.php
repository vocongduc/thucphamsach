...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="box box-primary">
            ...
            @endif
            <form role="form" method="POST" action="{{ url('admincp/news/edit/'.$news->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                            ...
                            <textarea class="form-control" name="summary" cols="50" rows="10"
                                      placeholder="Nhập tóm tắt nội dung">{{ $news->summary }}</textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div id="viewImg">
                        <img width="100px" src="assets/img_new/{{$news ->image}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline">
                        <input name="focus" value="0" checked="" type="radio">Có
                    </label>
                    <label class="radio-inline">
                        <input name="focus" value="1" type="radio">Không
                    </label>
                </div>
                {{--Hết tiêu điểm--}}
