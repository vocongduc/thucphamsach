...
<a target="_blank" href="{{ url('') }}" class="logo">
    ...
    <span class="logo-lg"><b>Admin</b> NCD</span>
</a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu">
                    <li class="header">You have {{$mess}} messages</li>
                    <li>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                <a class="btn btn-default" data-toggle="modal" data-target="#myModal" onclick="show({{ $value->id}})">
                                    ...
                                    <h4>
                                        <input type="text" value="{{$value->fullname}}" name="fullname" style="border: none; background: none;" readonly id="fullname{{ $value->id}}"> 
                                    </h4>
                                    ...
                                    <input type="text" value="{{$value->phone}}" style="border: none; background: none;" readonly id="phone{{ $value->id}}" hidden>
                                    <input type="text" value="{{$value->email}}" style="border: none; background: none;" readonly id="email{{ $value->id}}" hidden>
                                </a>
                            </li>
                            ...
                            <small>
                                <tr>
                                    @switch(Auth::user()->level)
                                        @case(1)
                                        <td>Cộng tác viên</td>
                                        @break
                                        @case(2)
                                        <td>Quản trị viên</td>
                                        @break
                                        @default
                                        <td>Administrator</td>
                                    @endswitch
