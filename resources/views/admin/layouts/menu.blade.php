        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('news.index')}}"><i class="fa fa-list"></i> Dánh sách</a></li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('recruitment.add')}}"><i class="fa fa-plus"></i> Thêm tin tuyển dụng</a></li>
                    <li><a href="{{route('recruitment.index')}}"><i class="fa fa-list"></i> Danh sách tuyển dụng</a></li>
                </ul>
            </li>
            <li class="treeview">
                    <a href="#">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('contact.index')}}"><i class="fa fa-list"></i> Danh sách tuyển dụng</a></li>
                    </ul>
                </li>
            <li class="treeview">
                <a href="#">
